...
public class TC_ytp_Check  extends Base_Class {
	...
	public void verify_ytp_journey
		(
		    ...
		    //Rider 
			String ADBChecked, String adb, String ATPD_PPPChecked, String atpd_PPP,  String ATPD_PPChecked, String CI_PPChecked, String CI_PPPChecked, String ci_ppp, String TI_Checked, 
...
//=================================================================  CREATE YOUR OWN PLAN  ===============================================================		
		...
		if(rop.equalsIgnoreCase("Y")) {
			Library.Custom_Click(ytp.rop(), "Rop Select");
